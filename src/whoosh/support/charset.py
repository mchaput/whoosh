...
#     keywords and maps it to destination char 'a' (but does not declare 'a' as
#     allowed).
#
# A..Z->a..z
#
#     Range mapping, declares all chars in source range as allowed and maps them
#     to the destination range. Does not declare destination range as allowed.
#     Also checks ranges' lengths (the lengths must be equal).
#
# a
#
...
# a..z
#
#     Stray range mapping, declares all characters in range as allowed and maps
#     them to themselves. Equivalent to a..z->a..z range mapping.
#
# A..Z/2
#
...
#     to themselves. For instance, A..Z/2 is equivalent to
#     A->B, B->B, C->D, D->D, ..., Y->Z, Z->Z.
#     This mapping shortcut is helpful for a number of Unicode blocks where
#     uppercase and lowercase letters go in such interleaved order instead of
#     contiguous chunks.
